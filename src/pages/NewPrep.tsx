...
import { useExamPreppContext, usePrepStarted } from '../context/ExamPreppContext';
 ...
 *  - A red advisory shows for fewer than 3 past questions (non-blocking).
 *
 * Once a run has started, this shows the shared PrepResults view instead of the
 * form — so the in-progress run is visible here too (state lives in the
 * app-level ExamPrepp context, surviving tab switches).
 */
